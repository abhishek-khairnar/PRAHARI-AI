  ...
  if (error && !data) {
    return (
      <div className="admin-error-box">
        ...
        <span>{error}</span>
        <button className="btn-admin-secondary" onClick={loadData}>Retry</button>
      </div>
    );
  }
    ...
    <div className="admin-page-content">
      <div className="admin-page-header">
        <div>
          ...
          <p className="admin-subtitle">Live health telemetry, incident workflows, and access management</p>
        </div>
        <button className="btn-admin-secondary" onClick={loadData} title="Refresh Telemetry">
      ...
      <div className="admin-kpi-grid">
        <div className="admin-kpi-card">
          ...
          <div className="kpi-info">
            ...
            <span className="kpi-value">{metrics.active_users || 0} <small>/ {metrics.total_users || 0}</small></span>
          </div>
        ...
        <div className="admin-kpi-card">
          ...
          <div className="kpi-info">
            ...
            <span className="kpi-value">{metrics.online_cameras || 0} <small>/ {metrics.total_cameras || 4} Online</small></span>
          </div>
        ...
        <div className="admin-kpi-card">
          ...
          <div className="kpi-info">
            ...
            <span className="kpi-value" style={{ fontSize: '1.25rem', color: 'var(--status-live)' }}>ONLINE</span>
          </div>
      ...
      <div className="admin-two-col-grid" style={{ marginTop: '1rem' }}>
        ...
        <div className="admin-card-section">
          ...
          {recentIncidents.length === 0 ? (
            <div className="admin-empty-state">No incidents logged.</div>
          ) : (
        ...
        <div className="admin-card-section">
          ...
          {recentAudits.length === 0 ? (
            <div className="admin-empty-state">No audit logs available.</div>
          ) : (
            <div className="admin-table-wrapper">
              <table className="admin-table">
                <thead>
                ...
                <tbody>
                  {recentAudits.map((a) => (
                    <tr key={a.id}>
                      <td className="mono-cell" style={{ fontSize: '0.75rem' }}>{a.timestamp.split(' ')[1] || a.timestamp}</td>
